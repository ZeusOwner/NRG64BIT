...
void native_StartKill(JNIEnv *env, jclass clazz, jobject contextObj) {
    ...
    auto apkFile = AAssetManager_open(assetMgr, "KuroEngine/data.apk", AASSET_MODE_UNKNOWN);
    ...
    if (!strcmp(gamePackage, "com.tencent.ig")) {
    ...
    } else if (!strcmp(gamePackage, "com.pubg.krmobile")) {
    ...
    } else if (!strcmp(gamePackage, "com.rekoo.pubgm")) {
    ...
    } else if (!strcmp(gamePackage, "com.vng.pubgmobile")) {
    ...
    } else if (!strcmp(gamePackage, "com.pubg.imobile")) {
